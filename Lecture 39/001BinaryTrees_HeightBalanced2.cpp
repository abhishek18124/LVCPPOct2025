...
MyPair checkHeightBalancedOptimised(TreeNode* root) {
	...
	MyPair left = checkHeightBalancedOptimised(root->left);
	...
	MyPair right = checkHeightBalancedOptimised(root->right);
...
int main() {
	...
	MyPair p = checkHeightBalancedOptimised(root);
