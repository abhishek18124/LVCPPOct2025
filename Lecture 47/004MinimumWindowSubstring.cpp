...
string minWindow(string s, string t) {
	...
	int tCnt = 0; // to store the no. of unique characters in 't'.
	...
	int minWLenSoFar = INT_MAX; // to track the length of the minimum window
	...
	return minWLenSoFar == INT_MAX ? "" : s.substr(s_index, minWLenSoFar);
}
