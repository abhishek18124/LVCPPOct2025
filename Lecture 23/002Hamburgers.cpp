...
bool canPolycarpusCook(ll m) {
    ...
    ll moneyINeed = e_b * p_b + e_s * p_s + e_c * p_c; // to store the money Polycarpus needs to purchase extra ingredients

    return moneyINeed <= r; // r is moneyIHave
...
int main() {
    ...
    ll hi = 1e12 + 100; // max. no. of hamburgers Polycarpus can make
